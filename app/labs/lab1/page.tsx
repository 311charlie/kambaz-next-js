  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        My favorite recipe: Crockpot Chicken
        <ol id="wd-your-favorite-recipe">
          <li>Place chicken in the crockpot.</li>
          <li>Pour taco seasoning over the chicken.</li>
          <li>Cover with the jar of salsa.</li>
          <li>Cook on low for 4-6 hours or high for 2-3 hours.</li>
          <li>Shred with two forks and stir in beans and corn before serving.</li>
        </ol>
        ...
        <ul id="wd-your-books">
          ...
          <li>The Setting Sun</li>
          <li>The Good Son</li>
          <li>The Old Garden</li>
          <li>We Do Not Part</li>
        </ul>
      </div>
      <div id="wd-tables">
        <h4>Table Tag</h4>
      ...
      <div id="wd-forms">
        ...
        <p>
          ...
          Click <a href="https://github.com/311charlie" id="wd-github">here</a> to go to my GitHub
        </p>
      </div>
    </div>
  );
